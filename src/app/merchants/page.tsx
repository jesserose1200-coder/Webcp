...
export const metadata = {
  title: 'لیست فروشگاه‌ها | تخفیف‌کده',
    ...
    <div className="container mx-auto px-4 py-8 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-3xl leading-relaxed">
          در این صفحه می‌توانید لیست تمامی فروشگاه‌های اینترنتی، تاکسی‌های آنلاین، سرویس‌های سفارش غذا و سایر خدمات آنلاین که دارای کد تخفیف فعال در تخفیف‌کده هستند را مشاهده کنید.
        </p>
      </div>
      ...
      <div className="mt-16 bg-gray-50 dark:bg-gray-800/50 p-8 rounded-2xl border border-gray-100 dark:border-gray-700">
         ...
         <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
           تخفیف‌کده به عنوان مرجع تخصصی کدهای تخفیف، لیست کاملی از این فروشگاه‌ها را به همراه جدیدترین و معتبرترین کدهای تخفیف آن‌ها گردآوری کرده است تا تجربه خریدی ارزان‌تر و لذت‌بخش‌تر را برای شما رقم بزند. با جستجو در این صفحه می‌توانید فروشگاه مورد نظر خود را پیدا کرده و قبل از خرید، از کدهای تخفیف آن استفاده نمایید.
         </p>
      </div>
